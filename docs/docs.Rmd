...
- This counts as part of your **in-class participation** for Lecture 6 and is due by Wednesday, 9/19 at midnight.
...
mojo_22_fall_wknd_wide[,2:4] <- round(mojo_22_fall_wknd_wide[,2:4],2)       # round cols 2-4

mojo_22_fall_wknd_wide |> write_csv("Week_4_In_Class_First_Name_Last_Name.csv") # export as .csv 

mojo_22_fall_wknd_wide |> kable()       # create kable table
...
- **Students with an accommodation: we will schedule an alternative.**
   ...
   - Tentative Time: Friday 9/29 at 1:00 PM in Room 009
...
- I will post a video playlist of solutions for Practice Questions on Thursday
...
***Point Solutions Session ID: bua455f23***
